 ...
 */
public class CopyOfSimpleHttpServer_BACKUP implements Runnable {
	/**
     *
     */
	 ...
	 * 开始服务器 Socket 线程.
	 */
	public CopyOfSimpleHttpServer_BACKUP() {
		try {
				...
				if (client != null) {
					...
					try {
						...
						if (resource.endsWith(".jpg")) {
							...
							out.println("这是一个支持虚拟路径的图片:<img src='abc.gif'><br>" + "<a href='abc.gif'>点击打开abc.gif, 是个服务器虚拟路径的图片文件.</a>");
	...
	public static void main(String[] args) {
		...
		new CopyOfSimpleHttpServer_BACKUP();
	}
